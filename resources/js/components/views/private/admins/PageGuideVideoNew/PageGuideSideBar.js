...
const PageGuideSideBar = ({ history, match, match_id, title, refetchsub }) => {
    ...
    const {
        ...
        "GET",
        `api/v1/guidesidebarvideo?id=${match_id}`,
        "guides_page_sidebar",
        res => {
                                                                                    ...
                                                                                    >
                                                                                        ...
                                                                                        >
                                                                                            <Link
                                                                                                ...
                                                                                                to={`/admin-video-guides/${card.id}/sub/${sub.id}`}
                                                                                            >
                                                                                                -{" "}
                                                                                                {
                                                                                                    sub.sub_title
                                                                                                                                    ...
                                                                                                                                    >
                                                                                                                                        ...
                                                                                                                                        >
                                                                                                                                            <Link
                                                                                                                                                ...
                                                                                                                                                to={`/admin-video-guides/${card.id}/sub/${sub.id}/sub-sub/${subsub.id}`}
                                                                                                                                            >
                                                                                                                                                --{" "}
                                                                                                                                                {
                                                                                                                                                    subsub.sub_sub_title
