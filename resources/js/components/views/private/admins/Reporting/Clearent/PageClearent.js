...
const PageClearent = ({ history, permission }) => {
                ...
                if (res.success) {
                    ...
                    res.data.data.map((value, key) => {
                        array_get.push({
                            ...
                            "Boarded Date": value.merchantBoardedDate
                                ? moment(value.merchantBoardedDate).format(
                                      "YYYY-MM-DD"
                                  )
                                : "",
                            Type: value.merchantIncorporationTypeDescription,
                            "Next Day Funding Enabled":
                                value.isMerchantNextDayFundingEnabled,
                            "Settlement Method":
                                value.merchantSettlementMethodName,
                            Status: value.merchantStatusDescription,
                            "Complience Status":
                                value.merchantComplianceStatusDescription,
                            "SAQ Type Code": value.merchantSAQTypeCode,
                            "SAQ Pass Date": value.merchantLastSAQPassDate
                                ? moment(value.merchantLastSAQPassDate).format(
                                      "YYYY-MM-DD"
                                  )
                                : "",
                            "SAQ Expiration Date": value.merchantSAQExpirationDate
                                ...
                                : "",
                            Email: value.merchantEmailAddress,
                            "Business Phone":
                            ...
                            "MCC Description": value.merchantMCCDescription,
                            "Physical Address":
                                value.merchantPhysicalAddressLine1 +
                                ", " +
                                value.merchantPhysicalCity +
                                ", " +
                                value.merchantPhysicalPostalCode,
                            "Principal Name": value.merchantPrincipal1FirstName
                        });
                    });
                    ...
                    if (userdata.role == "Merchant") {
                        if (res.total_count <= 1) {
                            history.push(
                                `/reporting/clearent/accounts/${res.data[0].merchantNumber}`
                            );
                            setShowTable(false);
                            //setShowTable(true);
                        } else {
        ...
        if (isMobile) {
            setShowTableColumnSettings({
                ...
                data: [
                    ...
                    { title: "Next Day Funding Enabled", show: false },
                    { title: "Settlement Method", show: false },
                    { title: "Status", show: false },
                    { title: "Complience Status", show: false },
                    { title: "SAQ Type Code", show: false },
                    { title: "SAQ Pass Date", show: false },
                    { title: "SAQ Expiration Date", show: false },
                    { title: "Email", show: false },
                    { title: "Business Phone", show: true },
                    { title: "Taxpayer Legal Name", show: false },
                    { title: "Tin Status Description", show: false },
                    { title: "Mailing Address", show: false },
                    { title: "MCC Description", show: false },
                    { title: "Physical Address", show: false },
                    { title: "Principal Name", show: false }
                ]
            });
        }
    }, []);
                ...
                <Col md={24}>
                    ...
                    >
                        <Row>
                            <Col md={8} xs={0}>
                                <div className="my-3">
                                    <b key="1"> Total: ({totalRecord})</b>
                                    <b key="2"> Open: ({openRecord})</b>
                                    <b key="3"> Closed: ({closeRecord})</b>
                                </div>
                            </Col>
                            <Col md={8} sm={0}></Col>
                            <Col md={8} sm={24}>
                        ...
                        <div className="table-responsive">
                            <ResizableAntdTable
                                ...
                                rowKey={record => record.merchantNumber}
                                dataSource={List ? List.data : []}
                                pagination={{
                                    pageSize: dataTableInfo.page_size,
                                    current: List ? List.current_page : 1,
