...
const PageFormsUpdate = ({ match }) => {
    ...
    const {
        ...
        "GET",
        "api/v1/forms/" + match.params.id,
        "table_forms_" + match.params.id,
        res => {
            if (res.success) {
                let form_inputs = [];
                // let _inputs = "";
    ...
    return (
        ...
        >
            <Card id="addnewform" title="Update Form">
                <div>
                    <Row gutter={16}>
                        <Col md={8}>
                            <Form
...
export default PageFormsUpdate;
