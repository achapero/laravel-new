...
const PageUserPermissionAdmin = ({ user_id, user_role, userClick }) => {
    ...
    // useEffect(() => {
    //     console.log('defaultChecked setMarketplaceVP', MarketplaceVP)
    // }, [MarketplaceVP])

    useEffect(() => {
        if(user_role == 'Super Admin' && userClick == '1'){
            ...
            // View As
            setViewAsVP(1)
        } else if(user_role == 'Admin' && userClick == '1'){
            alert('asd')
            ...
            // View As
            setViewAsVP(1)
        } else if (user_role == 'Manager' && userClick == '1') {
            // Marketplace
            setMarketplaceVP(0)
            ...
            // View As
            setViewAsVP(0)
        } else if (user_role == 'PAN Admin' && userClick == '1') {
            // Marketplace
            setMarketplaceVP(1)
        ...
        } else if (user_role == 'Merchant: Tickets Only' && userClick == '1') {
            // Marketplace
            setMarketplaceVP(0)
        ...
        } else if (user_role == 'Gift Only' && userClick == '1') {
            // Marketplace
            setMarketplaceVP(1)
