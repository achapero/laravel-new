        ...
        <div style={{ width: "100%" }}>
            <Row gutter={24}>
                <Col className="gutter-row" span={12}>
                    Merchant Acceptance of Application and Agreement
                    <span
                        style={{
                            position: "relative",
                            top: "3px",
                        ...
                        onClick={e =>
                            setSignatureTabs({
                                ...
                                mAccept: {
                                    ...
                                    isOpen: !signatureTabs.mAccept.isOpen
                                }
                            })
                        }
                        size="small"
                    >
                        {signatureTabs.mAccept.isOpen ? (
                            <span>
                    ...
                    <Col className="gutter-row" span={24}>
                        ...
                        {onBottom && (
                            <div className="text-center">
                                <Checkbox
                                    checked={signatureTabs.mAccept.isSigned}
                                    onClick={e => {
                                        setSignatureTabs({
                                            ...signatureTabs,
                                            mAccept: {
