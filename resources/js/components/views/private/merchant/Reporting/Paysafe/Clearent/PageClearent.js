        ...
        if (col_sizes) {
            Object.keys(col_sizes).map((title, key) => {
                ...
                $("table th:contains(" + title + ")").attr(
                    "width",
                    parseInt(Object.values(col_sizes)[key]) + 100
                );
            });
        }
        return () => {};
            ...
            {showTable ? (
                ...
                <>
                    <div className="text-center">
                        There is no Clearent assigned to this account yet. If
                        you feel this is in error, please open a support ticket
                        so we can connect it for you
                    </div>
                </>
            )}
        </div>
